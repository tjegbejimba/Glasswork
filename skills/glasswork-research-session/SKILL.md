...
8. **Keep membership explicit.** A durable addition joins Research context only
...
9. **Finish on durable state.** Report the evidence reviewed, Wiki Pages changed,
...
- Research Change Log writes belong to the separate Change Log contract; this
  skill does not invent or append a transcript-shaped history.
